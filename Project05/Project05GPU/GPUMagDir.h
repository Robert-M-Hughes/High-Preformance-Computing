...
__global__
void magnitude(float *Horizontal, float *Vertical, float *output_mag, int height, int width){
...
__global__
void direction(float *Horizontal, float *Vertical, float * output_grad, int height, int width){
