...
//Function
__global__
void sharedConvol(float* image,float* output, double *g_kernel, int height, int width, int k_height, int k_width){
...
__global__
void convolveHoriz(float* input, double* kernel, int k_w, int height, int width, float* output){
...
__global__
void convolveVert(float* input, double* kernel, int k_w, int height, int width, float* output){
